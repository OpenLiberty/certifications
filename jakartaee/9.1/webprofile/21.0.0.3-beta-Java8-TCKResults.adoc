...
== Open Liberty 21.0.0.3-beta Jakarta EE Web Profile 9.1 using Java 8 Certification Summary
...
+
link:21.0.0.3-beta-Java8-TCKResults.html[TCK results summary]
...
+
link:21.0.0.3-beta-Java8-signaturetest_results.log[Signature Test Results]
...
[INFO] Tests run: 1046, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,199.335 s - in TestSuite
[INFO]
[INFO] Results :
[INFO]
