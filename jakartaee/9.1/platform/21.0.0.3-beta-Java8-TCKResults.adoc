...
== Open Liberty 21.0.0.3-beta Jakarta EE Platform 9.1 using Java 8 Certification Summary
...
[INFO] Tests run: 1045, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,222.99 s - in TestSuite
[INFO]
[INFO] Results :
[INFO]
